...
//    NSLog(@"currentMonth month = %i day = %i, todaydate day = %i",[currentMonth month],[currentMonth day],[todayDate month]);
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        [date drawInRect:CGRectMake(targetX+1, targetY+12, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withFont:[UIFont fontWithName:@"HelveticaNeue-thin" size:17] lineBreakMode:UILineBreakModeClip alignment:UITextAlignmentCenter];
    }
